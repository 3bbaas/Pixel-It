...
namespace Pixel_It
{
    public class FilterPreview : System.Windows.Forms.Control
    {
        ...
        public FilterPreview()
        {
            ...
            cursorHand = new Cursor(assembly.GetManifestResourceStream("Pixel_It.harrow.cur"));
            cursorHandMove = new Cursor(assembly.GetManifestResourceStream("Pixel_It.hmove.cur"));
        }
